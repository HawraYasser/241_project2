...
namespace _241_project
{
    class dbcontrol
    {
        SqlConnection cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\dbtest.mdf;Integrated Security=True;Connect Timeout=30");
        SqlCommand cm;
